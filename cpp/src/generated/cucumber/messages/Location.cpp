...
namespace cucumber::messages
{
    ...
    {
        cucumber::messages::to_json(json, "line", line);
        cucumber::messages::to_json(json, "column", column);
    }

    void Location::from_json(const nlohmann::json& json)
    {
        cucumber::messages::from_json(json, "line", line);
        cucumber::messages::from_json(json, "column", column);
    }
