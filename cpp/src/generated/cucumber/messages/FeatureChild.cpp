...
{
    std::string FeatureChild::to_string() const
    {
    ...
    void FeatureChild::to_json(nlohmann::json& json) const
    {
        cucumber::messages::to_json(json, "rule", rule);
        cucumber::messages::to_json(json, "background", background);
        cucumber::messages::to_json(json, "scenario", scenario);
    }

    void FeatureChild::from_json(const nlohmann::json& json)
    {
        cucumber::messages::from_json(json, "rule", rule);
        cucumber::messages::from_json(json, "background", background);
        cucumber::messages::from_json(json, "scenario", scenario);
    }

    std::string FeatureChild::to_json() const
    {
        nlohmann::json json;
