...
{
    std::string TestStepFinished::to_string() const
    {
        ...
        cucumber::messages::to_string(oss, ", testStepResult=", testStepResult);
        cucumber::messages::to_string(oss, ", timestamp=", timestamp);

        return oss.str();
    }

    void TestStepFinished::to_json(nlohmann::json& json) const
    {
        cucumber::messages::to_json(json, "testCaseStartedId", testCaseStartedId);
        cucumber::messages::to_json(json, "testStepId", testStepId);
        cucumber::messages::to_json(json, "testStepResult", testStepResult);
        cucumber::messages::to_json(json, "timestamp", timestamp);
    }

    void TestStepFinished::from_json(const nlohmann::json& json)
    {
        ...
        cucumber::messages::from_json(json, "testStepResult", testStepResult);
        cucumber::messages::from_json(json, "timestamp", timestamp);
    }

    std::string TestStepFinished::to_json() const
    {
        nlohmann::json json;
