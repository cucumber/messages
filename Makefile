...
messages.md: $(schemas) ./codegen/codegen.rb ./jsonschema/scripts/templates/markdown.md.erb ./jsonschema/scripts/templates/markdown.enum.md.erb
	ruby ./codegen/codegen.rb Markdown ./jsonschema markdown.md.erb > $@
	ruby ./codegen/codegen.rb Markdown ./jsonschema markdown.enum.md.erb >> $@
