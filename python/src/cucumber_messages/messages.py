...
class TableRow(BaseModel):
    ...
    cells: Sequence[TableCell] = Field(..., description="Cells in the row")
    id: str
...
class JavaMethod(BaseModel):
    ...
    method_parameter_types: Sequence[str] = Field(..., alias="methodParameterTypes")
...
class Product(BaseModel):
    ...
    version: str | None = Field(None, description="The product version")
...
class PickleTableRow(BaseModel):
    ...
    cells: Sequence[PickleTableCell] = Field(..., min_length=1)
...
class StepMatchArgument(BaseModel):
    ...
    parameter_type_name: str | None = Field(None, alias="parameterTypeName")
...
class StepMatchArgumentsList(BaseModel):
    ...
    step_match_arguments: Sequence[StepMatchArgument] = Field(..., alias="stepMatchArguments")
...
class TestStep(BaseModel):
    ...
    hook_id: str | None = Field(None, alias="hookId", description="Pointer to the `Hook` (if derived from a Hook)")
    id: str
    pickle_step_id: str | None = Field(
        None, alias="pickleStepId", description="Pointer to the `PickleStep` (if derived from a `PickleStep`)"
    )
    step_definition_ids: Sequence[str] | None = Field(
        None,
    ...
    step_match_arguments_lists: Sequence[StepMatchArgumentsList] | None = Field(
        None,
...
class Exception(BaseModel):
    ...
    stack_trace: str | None = Field(
        None, alias="stackTrace", description="The stringified stack trace of the exception that caused this result"
    )
...
class Attachment(BaseModel):
    ...
    test_case_started_id: str | None = Field(None, alias="testCaseStartedId")
    test_step_id: str | None = Field(None, alias="testStepId")
    url: str | None = Field(
        None,
...
class Examples(BaseModel):
    ...
    name: str
    description: str
    table_header: TableRow | None = Field(None, alias="tableHeader")
    table_body: Sequence[TableRow] = Field(..., alias="tableBody")
    id: str
...
class Step(BaseModel):
    ...
    keyword_type: KeywordType | None = Field(
        None,
        alias="keywordType",
    ...
    text: str
    doc_string: DocString | None = Field(None, alias="docString")
    data_table: DataTable | None = Field(None, alias="dataTable")
...
class SourceReference(BaseModel):
    ...
    uri: str | None = None
    java_method: JavaMethod | None = Field(None, alias="javaMethod")
    java_stack_trace_element: JavaStackTraceElement | None = Field(None, alias="javaStackTraceElement")
...
class Ci(BaseModel):
    ...
    url: str | None = Field(None, description="Link to the build")
...
class ParameterType(BaseModel):
    ...
    regular_expressions: Sequence[str] = Field(..., alias="regularExpressions", min_length=1)
    ...
    id: str
    source_reference: SourceReference | None = Field(None, alias="sourceReference")
...
class TestCase(BaseModel):
    ...
    test_steps: Sequence[TestStep] = Field(..., alias="testSteps")
...
class TestStepResult(BaseModel):
    ...
    status: Status
    exception: Exception | None = Field(None, description="Exception thrown while executing this step, if any.")
...
class Hook(BaseModel):
    ...
    name: str | None = None
    source_reference: SourceReference = Field(..., alias="sourceReference")
    tag_expression: str | None = Field(None, alias="tagExpression")
...
class PickleStepArgument(BaseModel):
    ...
    doc_string: PickleDocString | None = Field(None, alias="docString")
    data_table: PickleTable | None = Field(None, alias="dataTable")
...
class PickleStep(BaseModel):
    ...
    ast_node_ids: Sequence[str] = Field(
        ...,
        alias="astNodeIds",
...
class Rule(BaseModel):
    ...
    tags: Sequence[Tag] = Field(..., description="All the tags placed above the `Rule` keyword")
    keyword: str
    name: str
    description: str
...
class Pickle(BaseModel):
    ...
    steps: Sequence[PickleStep] = Field(..., description="One or more steps")
    tags: Sequence[PickleTag] = Field(
        ...,
...
class Feature(BaseModel):
    ...
    tags: Sequence[Tag] = Field(..., description="All the tags placed above the `Feature` keyword")
    language: str = Field(
        ...,
        description="The [ISO 639-1](https://en.wikipedia.org/wiki/ISO_639-1) language code of the Gherkin document",
    )
    keyword: str = Field(..., description="The text of the `Feature` keyword (in the language specified by `language`)")
    ...
    children: Sequence[FeatureChild] = Field(..., description="Zero or more children")
...
class GherkinDocument(BaseModel):
    ...
    comments: Sequence[Comment] = Field(..., description="All the comments in the Gherkin document")
...
class Envelope(BaseModel):
    ...
    gherkin_document: GherkinDocument | None = Field(None, alias="gherkinDocument")
    hook: Hook | None = None
    meta: Meta | None = None
    parameter_type: ParameterType | None = Field(None, alias="parameterType")
    parse_error: ParseError | None = Field(None, alias="parseError")
    pickle: Pickle | None = None
    source: Source | None = None
    step_definition: StepDefinition | None = Field(None, alias="stepDefinition")
    test_case: TestCase | None = Field(None, alias="testCase")
    test_case_finished: TestCaseFinished | None = Field(None, alias="testCaseFinished")
    test_case_started: TestCaseStarted | None = Field(None, alias="testCaseStarted")
    test_run_finished: TestRunFinished | None = Field(None, alias="testRunFinished")
    test_run_started: TestRunStarted | None = Field(None, alias="testRunStarted")
    test_step_finished: TestStepFinished | None = Field(None, alias="testStepFinished")
    test_step_started: TestStepStarted | None = Field(None, alias="testStepStarted")
    undefined_parameter_type: UndefinedParameterType | None = Field(None, alias="undefinedParameterType")
