...
public final class TestCase {
    ...
    public TestCase(
        ...
        @PropertyName("pickleId") String pickleId,
        @PropertyName("testSteps") List<TestStep> testSteps,
        ...
        this.testSteps = List.copyOf(requireNonNull(testSteps, "TestCase.testSteps cannot be null"));
